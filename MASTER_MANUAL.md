...
- **Admin panel split plan** (incremental extractions; `uteSurface` done): [docs/ADMIN_PANEL_SPLIT_PLAN.md](./docs/ADMIN_PANEL_SPLIT_PLAN.md).
...
- **`npm run lint`** — ESLint on **stabilization slice** only:
  ...
  - `src/admin/AdminSectionBoundary.jsx`, `src/admin/AdminErrorBoundary.jsx`, `src/admin/adminMenuIds.js`, `src/admin/panels/UteSurfacePanel.jsx`
