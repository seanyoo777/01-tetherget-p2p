...
export function UteSurfacePanel({
  theme,
  uteSurfaceMetrics,
  visible,
  ...
  return (
    <div
      data-testid={P2P_TEST_IDS.uteSurfacePanel}
      className={`${visible ? "" : "hidden "}mb-4 rounded-3xl border p-4 ${theme.card}`}
    >
        ...
        <div className="grid grid-cols-2 gap-2 sm:grid-cols-3">
          ...
          <div className={`rounded-xl p-3 ${theme.cardSoft}`}>
            ...
            <div className="break-all font-mono text-xs font-black">
              {uteSurfaceMetrics.p2p_escrow_locked_minor_total}
            </div>
          </div>
          <div className={`rounded-xl p-3 ${theme.cardSoft}`}>
